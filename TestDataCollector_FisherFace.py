# --------------- COLLECTS DATA ON FISHERFACE BY RUNNING IT ON A GIVEN IMAGE AND SAVING DATA TO A TEXT FILE -------------
...
for (x, y, w, h) in faces:
    ...
    fish_conf = []
    for _ in range(200):
        recog = cv2.face.FisherFaceRecognizer_create(Lev)  # creating EIGEN FACE RECOGNISER
